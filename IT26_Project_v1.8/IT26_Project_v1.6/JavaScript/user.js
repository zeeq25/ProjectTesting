  ...
  class mySideBar extends HTMLElement {
    connectedCallback() {
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="../user-portal/user-pending-returns.html" class="list-group-item list-group-item-action"><i class="bi bi-hourglass-split"> </i>Pending Returns</a>
            <a href="../user-portal/user-fines.html" class="list-group-item list-group-item-action"><i class="bi bi-exclamation-triangle"> </i>Fines</a>
            <a href="../user-portal/user-bookmarks.html" class="list-group-item list-group-item-action"><i class="bi bi-bookmark"> </i>Bookmarks</a>
        </div>
        `;
